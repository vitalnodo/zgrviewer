			...
			case '.':
			{
				...
				do {
					if (((LA(1) >= '0' && LA(1) <= '9'))) {
						...
						if ( _cnt1232>=1 ) { break _loop1232; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
					}
				...
				case '.':
				{
					...
					do {
						if (((LA(1) >= '0' && LA(1) <= '9'))) {
							...
							if ( _cnt1243>=1 ) { break _loop1243; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
						}
